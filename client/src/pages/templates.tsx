...
export default function Templates() {
  ...
  const getIndustryColor = (industry: string) => {
    const colors: Record<string, string> = {
      fine_dining: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400",
      casual_dining: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400",
